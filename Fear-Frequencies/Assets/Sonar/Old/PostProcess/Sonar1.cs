...
public class Sonar1 : MonoBehaviour
{
    [SerializeField] private PostProcessVolume volume;
    private SonarPostProcess _sonarPostProcess;
    ...
    {
        _camera = Camera.main;
        _sonarPostProcess = (SonarPostProcess)volume.profile.settings[0];
        _wavePool = new WavePoolManager(200, waveSpeed, waveMaxDistance, _sonarPostProcess);
    }

    // Update is called once per frame
    void Update()
    {
        _sonarPostProcess.inverseMatrix.value = _camera.cameraToWorldMatrix;
    ...
    class WavePoolManager
    {
        ...
        private readonly SonarPostProcess _postProcess;
        private Texture2D _texture2D;

        public WavePoolManager(int poolCapacity, float waveSpeed, float waveMaxDistance, SonarPostProcess postProcess)
        {
        ...
        public void Update(float deltaTime)
        {
            ...
            _postProcess.waveData.value = _texture2D;
            _postProcess.width.value = 5;
            _postProcess.height.value = _poolCapacity;
        }
